...
(function () {
  ...
  window.onload = (event) => {
     ...
     * Creating new button
     */
     var newButton = '<a id="newLinkedIn" class="mr-1 btn btn-sm badge-linkedin text-light mb-1"><span class="icon baseline mr-1 text-light"><svg><use href="/static/icons.06c57406e4fc.svg#brands--linkedin"></use></svg></span>Add Cert to LinkedIn</a>'
    ...
    document.getElementById('newLinkedIn').addEventListener("click", addToLinkedIn)
